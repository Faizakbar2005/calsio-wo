...
// ─── Exercises Data ──────────────────────────────────────────────────────────
const exercises = [
  { name: 'Push Up',        icon: exerciseIcons['Push Up'],        muscle: 'Dada',     muscleIcon: muscleIcons['Dada'],     equipment: 'No Equipment',    level: 'beginner',     met: 3.8, color: '#eab308', desc: 'Gerakan dasar mendorong tubuh naik turun dengan tangan, melatih dada, bahu, dan trisep secara bersamaan.', steps: ['Posisi plank dengan tangan selebar bahu','Turunkan dada hingga hampir menyentuh lantai','Siku membentuk sudut 45° dari tubuh','Dorong kembali ke atas dengan kuat','Jaga tubuh lurus dari kepala hingga tumit sepanjang gerakan'], muscles: ['Pectoralis Major','Deltoid Anterior','Triceps Brachii','Core'], tip: 'Jaga siku tidak terlalu keluar. Fokus pada squeeze dada di puncak gerakan untuk hasil maksimal.' },
  { name: 'Pull Up',        icon: exerciseIcons['Pull Up'],        muscle: 'Punggung', muscleIcon: muscleIcons['Punggung'], equipment: 'Basic Equipment',  level: 'intermediate', met: 5.0, color: '#60a5fa', desc: 'Gerakan menarik tubuh ke atas menggunakan palang, sangat efektif untuk membangun lebar punggung dan kekuatan bisep.', steps: ['Pegang palang dengan jarak lebih lebar dari bahu, telapak menghadap depan','Gantung dengan lengan lurus penuh','Tarik tubuh ke atas hingga dagu melewati palang','Fokus tarik siku ke bawah, bukan tangan ke atas','Turunkan perlahan dengan kontrol penuh'], muscles: ['Latissimus Dorsi','Biceps Brachii','Teres Major','Rhomboid'], tip: 'Bayangkan kamu mau memasukkan siku ke kantong celana. Ini memaksimalkan aktivasi lat.' },
  { name: 'Squat',          icon: exerciseIcons['Squat'],          muscle: 'Kaki',     muscleIcon: muscleIcons['Kaki'],     equipment: 'No Equipment',    level: 'beginner',     met: 5.0, color: '#22c55e', desc: 'Raja latihan kaki. Melatih seluruh otot tungkai bawah sekaligus dan sangat fungsional untuk kehidupan sehari-hari.', steps: ['Kaki selebar bahu, jari kaki sedikit keluar','Rentangkan tangan ke depan untuk keseimbangan','Turunkan pinggul ke bawah seolah duduk di kursi','Lutut mengikuti arah jari kaki, tidak ke dalam','Turunkan hingga paha sejajar lantai, lalu dorong naik'], muscles: ['Quadriceps','Gluteus Maximus','Hamstring','Core','Calves'], tip: 'Jaga dada tetap tegak dan berat badan di tumit. Jangan biarkan lutut jatuh ke dalam.' },
  { name: 'Deadlift',       icon: exerciseIcons['Deadlift'],       muscle: 'Punggung', muscleIcon: muscleIcons['Punggung'], equipment: 'Basic Equipment',  level: 'advanced',     met: 6.0, color: '#f97316', desc: 'Gerakan compound paling fungsional. Melatih hampir semua otot posterior tubuh dari punggung bawah hingga kaki.', steps: ['Kaki selebar pinggul, bar di depan tulang kering','Bungkuk dan pegang bar dengan grip selebar bahu','Punggung lurus, dada tegak, pandangan ke depan','Angkat bar dengan mendorong lantai menggunakan kaki','Kunci pinggul di atas, turunkan kembali dengan kontrol'], muscles: ['Erector Spinae','Gluteus Maximus','Hamstring','Trapezius','Quadriceps'], tip: 'Bayangkan kamu mendorong bumi ke bawah, bukan menarik bar ke atas. Ini menjaga postur tetap benar.' },
  { name: 'Plank',          icon: exerciseIcons['Plank'],          muscle: 'Perut',    muscleIcon: muscleIcons['Perut'],    equipment: 'No Equipment',    level: 'beginner',     met: 3.5, color: '#a78bfa', desc: 'Latihan isometrik terbaik untuk core. Melatih stabilitas seluruh batang tubuh tanpa gerakan berulang.', steps: ['Posisi push up, tapi tumpuan di lengan bawah','Siku tepat di bawah bahu','Tubuh lurus dari kepala hingga tumit','Perut dikencangkan, pantat tidak naik atau turun','Tahan posisi selama durasi yang ditentukan'], muscles: ['Rectus Abdominis','Transverse Abdominis','Obliques','Erector Spinae'], tip: 'Bayangkan ada gelas berisi air di punggungmu. Jaga agar tidak tumpah.' },
  { name: 'Lunges',         icon: exerciseIcons['Lunges'],         muscle: 'Kaki',     muscleIcon: muscleIcons['Kaki'],     equipment: 'No Equipment',    level: 'beginner',     met: 4.0, color: '#22c55e', desc: 'Gerakan unilateral yang melatih keseimbangan dan kekuatan kaki secara bergantian.', steps: ['Berdiri tegak, kaki rapat','Langkahkan satu kaki ke depan panjang','Turunkan lutut belakang mendekati lantai','Lutut depan tidak melewati jari kaki','Dorong kembali ke posisi awal dan ganti sisi'], muscles: ['Quadriceps','Gluteus Maximus','Hamstring','Calves'], tip: 'Jaga torso tegak lurus. Condong ke depan mengurangi keterlibatan glutes.' },
  { name: 'Dumbbell Curl',  icon: exerciseIcons['Dumbbell Curl'],  muscle: 'Bisep',    muscleIcon: muscleIcons['Bisep'],    equipment: 'Basic Equipment',  level: 'beginner',     met: 3.5, color: '#f472b6', desc: 'Latihan isolasi klasik untuk bisep. Sederhana namun sangat efektif untuk membangun ukuran dan kekuatan lengan depan.', steps: ['Berdiri tegak, dumbbell di tangan dengan telapak menghadap depan','Siku menempel di sisi tubuh sepanjang gerakan','Angkat dumbbell dengan memfleksikan siku','Squeeze bisep di puncak gerakan','Turunkan perlahan dengan kontrol penuh'], muscles: ['Biceps Brachii','Brachialis','Brachioradialis'], tip: 'Hindari mengayun tubuh. Fase turun (eksentrik) sama pentingnya dengan angkat.' },
  { name: 'Tricep Dip',     icon: exerciseIcons['Tricep Dip'],     muscle: 'Trisep',   muscleIcon: muscleIcons['Trisep'],   equipment: 'Basic Equipment',  level: 'intermediate', met: 4.0, color: '#fb923c', desc: 'Gerakan compound untuk trisep menggunakan beban tubuh sendiri.', steps: ['Duduk di tepi kursi/bangku, tangan di pinggir','Geser tubuh ke depan, kaki lurus atau ditekuk','Turunkan tubuh dengan menekuk siku ke belakang','Turunkan hingga siku membentuk sudut 90°','Dorong kembali ke atas dengan trisep'], muscles: ['Triceps Brachii','Deltoid Anterior','Pectoralis Minor'], tip: 'Jaga siku tetap ke belakang, bukan ke samping.' },
  { name: 'Hip Thrust',     icon: exerciseIcons['Hip Thrust'],     muscle: 'Bokong',   muscleIcon: muscleIcons['Bokong'],   equipment: 'Basic Equipment',  level: 'intermediate', met: 4.5, color: '#f43f5e', desc: 'Gerakan terbaik untuk mengaktifkan glutes secara maksimal.', steps: ['Punggung bersandar di bangku, kaki selebar pinggul di lantai','Beban (dumbbell/barbell) di atas pinggul','Dorong pinggul ke atas hingga tubuh membentuk garis lurus','Squeeze glutes kuat-kuat di posisi atas','Turunkan perlahan hingga bokong hampir menyentuh lantai'], muscles: ['Gluteus Maximus','Gluteus Medius','Hamstring','Core'], tip: 'Jaga dagu menunduk dan rib cage turun. Hindari hyperextend punggung bawah.' },
  { name: 'Jumping Jack',   icon: exerciseIcons['Jumping Jack'],   muscle: 'Kardio',   muscleIcon: muscleIcons['Kardio'],   equipment: 'No Equipment',    level: 'beginner',     met: 8.0, color: '#34d399', desc: 'Latihan kardio full-body yang sempurna untuk warm-up atau sesi kardio intensitas sedang.', steps: ['Berdiri tegak, kaki rapat dan tangan di sisi tubuh','Lompat sambil membuka kaki selebar bahu','Bersamaan angkat tangan ke atas hingga hampir bertemu','Lompat kembali ke posisi awal','Ulangi dengan ritme yang konsisten'], muscles: ['Full Body','Deltoid','Gluteus Medius','Calves','Core'], tip: 'Mendarat dengan lembut pada bola kaki untuk meminimalkan impak pada sendi lutut.' },
  { name: 'Shoulder Press', icon: exerciseIcons['Shoulder Press'], muscle: 'Bahu',     muscleIcon: muscleIcons['Bahu'],     equipment: 'Basic Equipment',  level: 'intermediate', met: 4.0, color: '#818cf8', desc: 'Gerakan compound untuk bahu yang juga melatih trisep dan upper chest.', steps: ['Duduk atau berdiri tegak, dumbbell di ketinggian bahu','Telapak tangan menghadap ke depan','Dorong dumbbell ke atas hingga lengan lurus','Jangan kunci siku di posisi atas','Turunkan perlahan ke posisi awal'], muscles: ['Deltoid','Triceps Brachii','Upper Trapezius','Serratus Anterior'], tip: 'Jaga core tetap kencang. Jangan melengkungkan punggung bawah.' },
  { name: 'Mountain Climber', icon: exerciseIcons['Mountain Climber'], muscle: 'Perut', muscleIcon: muscleIcons['Perut'],   equipment: 'No Equipment',    level: 'intermediate', met: 8.0, color: '#a78bfa', desc: 'Kombinasi latihan core dan kardio. Intensitas tinggi dalam satu gerakan.', steps: ['Mulai dari posisi push up tinggi','Bawa lutut kanan menuju dada dengan cepat','Kembali dan langsung ganti dengan lutut kiri','Gerakan bergantian seperti sedang lari di tempat','Jaga pinggul tidak naik, tubuh tetap lurus'], muscles: ['Rectus Abdominis','Obliques','Hip Flexors','Deltoid','Core'], tip: 'Semakin cepat semakin tinggi intensitas kardionya. Untuk fokus core, lakukan lebih lambat.' },
]

// ─── Muscle Guides ───────────────────────────────────────────────────────────
const muscleGuides = [
  { name: 'Dada (Chest)',     latin: 'Pectoralis Major & Minor',               icon: muscleIcons['Dada'],     color: '#eab308', desc: 'Otot dada adalah otot besar yang mencakup seluruh bagian depan atas tubuh. Berfungsi untuk gerakan mendorong horizontal dan adduksi lengan.', exercises: ['Push Up','Bench Press','Chest Fly','Dips'], tip: 'Latih dada 2x seminggu. Variasikan sudut (incline, flat, decline) untuk melatih semua bagian dada.' },
  { name: 'Punggung (Back)',  latin: 'Latissimus Dorsi & Rhomboids',           icon: muscleIcons['Punggung'], color: '#60a5fa', desc: 'Punggung adalah grup otot terbesar kedua di tubuh. Terdiri dari lat (lebar), rhomboid (tengah), dan trapezius (atas).', exercises: ['Pull Up','Deadlift','Bent Over Row','Lat Pulldown'], tip: 'Jangan skip latihan punggung. Ketidakseimbangan dada-punggung adalah penyebab utama postur bungkuk.' },
  { name: 'Kaki (Legs)',      latin: 'Quadriceps & Hamstrings',                icon: muscleIcons['Kaki'],     color: '#22c55e', desc: 'Kaki adalah kelompok otot terbesar di tubuh. Melatih kaki meningkatkan metabolisme secara keseluruhan dan kekuatan fungsional.', exercises: ['Squat','Lunges','Leg Press','Leg Curl'], tip: 'Jangan pernah skip leg day. Otot kaki yang besar membantu membakar lebih banyak kalori bahkan saat istirahat.' },
  { name: 'Bokong (Glutes)', latin: 'Gluteus Maximus, Medius & Minimus',      icon: muscleIcons['Bokong'],   color: '#f43f5e', desc: 'Glutes adalah otot terbesar di tubuh manusia. Glutes yang kuat sangat penting untuk stabilitas panggul dan mencegah nyeri punggung bawah.', exercises: ['Hip Thrust','Squat','Deadlift','Glute Bridge'], tip: 'Banyak orang mengalami "glute amnesia" karena terlalu banyak duduk. Aktifkan glutes dengan peregangan hip flexor sebelum latihan.' },
  { name: 'Bahu (Shoulders)', latin: 'Deltoideus Anterior, Medial & Posterior', icon: muscleIcons['Bahu'],   color: '#818cf8', desc: 'Bahu terdiri dari tiga kepala: anterior (depan), medial (tengah), dan posterior (belakang). Bahu medial yang berkembang memberi tampilan lebar.', exercises: ['Shoulder Press','Lateral Raise','Front Raise','Face Pull'], tip: 'Perbanyak latihan posterior deltoid. Kebanyakan orang over-train anterior deltoid dari push up dan bench press.' },
  { name: 'Bisep (Biceps)',   latin: 'Biceps Brachii & Brachialis',            icon: muscleIcons['Bisep'],    color: '#f472b6', desc: 'Bisep bekerja melakukan fleksi siku dan supinasi lengan bawah. Bisep banyak terlatih saat latihan punggung.', exercises: ['Dumbbell Curl','Barbell Curl','Hammer Curl','Pull Up'], tip: 'Variasikan grip untuk melatih semua bagian bisep: supinasi untuk puncak bisep, netral (hammer) untuk brachialis.' },
  { name: 'Trisep (Triceps)', latin: 'Triceps Brachii',                        icon: muscleIcons['Trisep'],   color: '#fb923c', desc: 'Trisep membentuk 2/3 massa lengan atas, jauh lebih besar dari bisep. Trisep yang kuat sangat penting untuk semua gerakan mendorong.', exercises: ['Tricep Dip','Skull Crusher','Tricep Pushdown','Close-Grip Push Up'], tip: 'Untuk lengan besar, fokus pada trisep lebih dari bisep. Gerakan overhead paling mengaktifkan kepala panjang trisep.' },
  { name: 'Perut (Core)',     latin: 'Rectus Abdominis & Obliques',            icon: muscleIcons['Perut'],    color: '#a78bfa', desc: 'Core bukan hanya six-pack, tapi juga obliques, transverse abdominis, dan erector spinae. Core yang kuat adalah fondasi semua gerakan atletik.', exercises: ['Plank','Crunch','Mountain Climber','Leg Raise'], tip: 'Six-pack dibuat di dapur, bukan di gym. Latihan core membangun otot, tapi lemak perut hilang dengan defisit kalori.' },
...
// ─── Exports ─────────────────────────────────────────────────────────────────
export {
  muscleIcons, exerciseIcons, nutrisiIcons, makroIcons,
